...
class Crypt
{
	...
	final protected static function getMethod(): string
	{
		return Application::getConfig('application')
			->getArrayItem('security', 'openssl_default_method') ?? self::DEFAULT_METHOD;
	}

	/**
	 * Decrypt encrypted string. If you provided key and/or method to encrypt, then you have to use the same values
	 * here as well.
	 *
