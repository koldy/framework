...
/**
 * This cache adapter holds cached data only in request's scope (memory, or runtime). As soon as request/script ends,
 * everything will disappear. It's best use is in CLI scripts.
 *
