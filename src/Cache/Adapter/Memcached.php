...
/**
 * The Memcached adapter defined in Koldy is using Memcached and not Memcache class. Notice the difference with "d"
 * letter. In order the use this adapter, your PHP installation must have Memcached extension available. To be sure,
 * run your phpinfo() and check if Memcache adapter is mentioned.
 *
...
class Memcached extends AbstractCacheAdapter
{
	...
	public function getInstance(): NativeMemcached
	{
		if ($this->memcached === null) {
			...
			$adapterOptions = [
				NativeMemcached::OPT_LIBKETAMA_COMPATIBLE => true
				// recommended on https://www.php.net/manual/en/memcached.constants.php
			];
